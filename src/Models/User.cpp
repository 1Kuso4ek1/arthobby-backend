...
std::vector<Cart> User::getCart(const DbClientPtr &clientPtr) const {
    static const std::string sql = "select * from cart where user_id = $1";
    Result r(nullptr);
    {
...
void User::getCart(const DbClientPtr &clientPtr,
