...
class Cart
{
  public:
     ...
     */
    explicit Cart(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Cart(const Json::Value &pJson) noexcept(false);
     ...
     */
    Cart(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    void getUser(const drogon::orm::DbClientPtr &clientPtr,
                 ...
                 const drogon::orm::ExceptionCallback &ecb) const;
  private:
    friend drogon::orm::Mapper<Cart>;
    friend drogon::orm::BaseBuilder<Cart, true, true>;
    friend drogon::orm::BaseBuilder<Cart, true, false>;
    friend drogon::orm::BaseBuilder<Cart, false, true>;
    friend drogon::orm::BaseBuilder<Cart, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Cart>;
#endif
